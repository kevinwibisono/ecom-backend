              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td class="logo" style="text-align: center;">
                    <h1><a href="#">Account Verification</a></h1>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      <h3>Hello ${nama_user}!
                              Terima kasih telah mendaftarkan diri anda di [nama website], sebelum kamu melakukan transaksi pertamamu, silahkan verifikasi emailmu dengan meng-klik link dibawah ini:
                              </h3>
                      <p><a href="http://localhost:3000/verify?t=${token}" class="btn btn-primary">Verifikasi Email</a></p>
                    </div>
                  </td>
                </tr>
              </table>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          <tr>
            <td valign="middle" class="bg_light footer email-section">
              <table>
                <tr>
                  <td valign="top" width="66.667%" style="padding-top: 20px;">
